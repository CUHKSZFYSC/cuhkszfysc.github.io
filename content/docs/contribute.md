...
感谢你查看这份指南并着手分享你的经验！要进行分享，主要有两个方法：

1. **对运营团队简单，对您复杂：** 通过 GitHub Pull Request 进行贡献（推荐），具体有两种方式：
   - 直接在 GitHub 网页上进行编辑，或者
   - Fork 本仓库，clone 到本地，修改，发起 PR（**强烈推荐**）
2. **对运营团队复杂，对您简单：** 直接上传文件。可在网站 GitHub 仓库中新建一个 Issue，并上传你的帖子文件。或直接将文件发送给我们（邮箱：TBD）。建议使用 Markdown（`.md`）文件，其他文件格式也可。
...
- 飞跃手册其他帖子的[源代码](https://github.com/CUHKSZFYSC/cuhkszfysc.github.io/tree/main/docs)
- 由飞跃手册维护者撰写的经验分享示例（当前暂未保留）
...
::: warning
GitHub 的用户界面可能在本指南发布后有所变动，请以实际为准。如遇到问题，欢迎在[讨论区](https://github.com/CUHKSZFYSC/cuhkszfysc.github.io/discussions)提出。
:::

1. 访问我们的[仓库](https://github.com/CUHKSZFYSC/cuhkszfysc.github.io/tree/main/docs/)，并进入你的分享所属的文件夹，如 `grad-application/computer-science-and-engineering`。
2. 点击右上角 `Add file`
...
这一节假定你已经安装了 git 和相关的编辑器等工具，并且对 git 的使用有最基本的了解。如果你对 git 不甚了解，欢迎你联系维护者寻求帮助，在[讨论区](https://github.com/CUHKSZFYSC/cuhkszfysc.github.io/discussions)提问，或者参考 [git 文档](https://git-scm.com/doc)进行学习。

1. [Fork](https://github.com/CUHKSZFYSC/cuhkszfysc.github.io/fork) 我们的仓库。
2. `clone` 你的 fork 到本地。
...
- 撰写经验分享帖子
- 在仓库中[创建新 Issue](https://github.com/CUHKSZFYSC/cuhkszfysc.github.io/issues/new)，并将你的帖子作为附件上传。
...
如果你对建设飞跃手册感兴趣，欢迎联系 <dancewithdiantong@gmail.com> 加入维护团队！
